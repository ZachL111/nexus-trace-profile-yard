...
nexus-trace-profile-yard is a Scala project for observability. It focuses on this technical goal: Package a Scala local lab for profile analysis with windowed input fixtures, late-data behavior checks, and documented operating limits.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 180, risk penalty 6, latency penalty 4, and weight bonus 3. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
