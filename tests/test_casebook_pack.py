"""Regression checks for the nexus-trace-profile-yard casebook."""
...
from casebook.harness import assert_expected, nexus_trace_profile_yard_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(nexus_trace_profile_yard_summary(), assert_expected())
